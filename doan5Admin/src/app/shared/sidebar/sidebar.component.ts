...
export class SidebarComponent implements OnInit, AfterViewInit {
  ...
  {name:'Danh mục quản lí',url:'',icon:'signal',childs:[{name:'Quản lý đơn hàng',url:'/product/order'},{name:'Quản lý loại sản phẩm',url:'/product/type'},{name:'Quản lý sản phẩm',url:'/product/product'},{name:'Quản lý khách hàng',url:'/product/customer'}]}];
  constructor() { } 
  ngOnInit(): void {
  }
  ngAfterViewInit() {
