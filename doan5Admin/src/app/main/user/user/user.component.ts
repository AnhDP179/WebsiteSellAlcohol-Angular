...
export class UserComponent extends BaseComponent implements OnInit {
  ...
  loadPage(page) {
    this._api
      .post('/api/users/search', { page: page, pageSize: this.pageSize })
  ...
  search() {
    ...
    this._api
      .post('/api/users/search', {
        ...
        taikhoan: this.formsearch.get('taikhoan').value,
      })
      .takeUntil(this.unsubscribe)
      .subscribe((res) => {
        this.users = res.data;
  ...
  onSubmit(value) {
    ...
    if (this.isCreate) {
      this.getEncodeFromImage(this.file_image).subscribe((data: any): void => {
        ...
        this._api
          .post('/api/users/create-user', tmp)
          .takeUntil(this.unsubscribe)
          .subscribe((res) => {
      ...
      this.getEncodeFromImage(this.file_image).subscribe((data: any): void => {
        ...
        this._api
          .post('/api/users/update-user', tmp)
          .takeUntil(this.unsubscribe)
          .subscribe((res) => {
  ...
  onDelete(row) {
    this._api
      .post('/api/users/delete-user', { id: row.id })
      .takeUntil(this.unsubscribe)
      .subscribe((res) => {
  ...
  public openUpdateModal(row) {
    ...
    setTimeout(() => {
      $('#createModal').modal('toggle');
      this._api
        .get('/api/users/get-by-id/' + row.id)
        .takeUntil(this.unsubscribe)
        .subscribe((res: any) => {
          this.user = res;
