...
namespace API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IHoaDonDAL, HoaDonDAL>();
            services.AddTransient<IHoaDonBLL, HoaDonBLL>();
            services.AddTransient<ICustomerDAL, CustomerDAL>();
            services.AddTransient<ICustomerBLL, CustomerBLL>();
            services.AddTransient<IThongKeDAL, ThongKeDAL>();
            services.AddTransient<IThongKeBLL, ThongKeBLL>();
